 ...
 * @author jcardozo
 */
public class PDFCarrerasMovil {
    PdfWriter writer = null;
 
    public PDFCarrerasMovil() {
        super();
    }
        ...
        try {      
            ...
            try {
              ...
              return false;
                ...
                parrafo.add("NOMBRE CHOFER: "+c.getLv_REFERENCIA());
                documento.add(parrafo);
                
                parrafo = new Paragraph();
                parrafo.setAlignment(Paragraph.ALIGN_CENTER);
                parrafo.setFont(FontFactory.getFont("Sans",14,Font.BOLD, BaseColor.RED));
                documento.add(parrafo);
                documento.add(new Paragraph("\n"));
                
            //Generar tabla del reporte
                PdfPTable tabla = new PdfPTable(7);
                float[] medidaCeldas = {0.50f, 1.25f, 0.60f, 0.55f, 0.40f, 0.55f, 0.55f};
